                    ...
                    this._getClusterId((err, cluster_id) => {
                        ...
                        this.getApplications((err, apps) => {
                            ...
                            _.forEach(apps, (app) => {
                                ...
                                const application_name_env_var_name = `CS_ADDRESS_${sanitized_app_id.toUpperCase()}`;
                                app_desc.env_vars[application_name_env_var_name] = `${app.id}.${cluster_id}.containership`;
                            });
            ...
            const updateReplicationController = (cb) => {
                ...
                this._applyConstraintsToApplication(existing_app, (err, app_desc) => {
                    ...
                    this._executePreDeployMiddleware(app_desc, (err, app_desc) => {
                        ...
                        return request({
                            uri: `${this.k8sApiUrl}/api/v1/namespaces/default/replicationcontrollers/${app_id}`,
                            method: 'PATCH',
                            body: k8s_app_desc,
                            json: true,
                            headers: {
